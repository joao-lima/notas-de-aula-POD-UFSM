...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.8\textwidth]{aula6-btree2v2}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.4\textwidth]{aula06-nchaves1}
...
Uma árvore \emph{kd} (árvore de pesquisa \emph{k-}dimensional) é uma estrutura
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.5\textwidth]{aula06-kd1}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.3\textwidth]{aula06-kd2}
...
Caso a árvore \emph{kd} não couber na memória, uma solução trivial seria 
