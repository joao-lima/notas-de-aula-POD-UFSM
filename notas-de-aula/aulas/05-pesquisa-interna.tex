...
\begin{itemize}
\item maior que zero ($> 0$) - sub-árvore da direita é menor.
\item menor que zero ($< 0$) - sub-árvore da esquerda é menor.
\item igual a zero ($= 0$) - sub-árvores tem a mesma altura.
\end{itemize}
...
Usada para indexar chaves de busca, em geral caracteres, 
